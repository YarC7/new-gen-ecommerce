...
export async function action({request, context}: ActionFunctionArgs) {
  ...
  try {
    ...
    return {
      success: false,
      errors: [{field: 'general', message: 'Operation failed. Please try again.'}],
    };
  }
            ...
            <div className="relative bg-white backdrop-blur-sm rounded-3xl shadow-2xl border border-white/50 p-8">
              ...
              <div className="relative z-10">
                ...
                <div className="flex items-center gap-3 mb-8">
                  ...
                  <span className="text-slate-600 font-medium">Address Book</span>
                </div>
                ...
                <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-6">
                  <div className="space-y-4">
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        <h1 className="text-4xl lg:text-5xl font-black bg-gradient-to-r from-slate-800 via-emerald-700 to-teal-700 bg-clip-text text-transparent">
                          Address Book
                        </h1>
                  ...
                  <div className="flex-shrink-0">
                    <button
                      onClick={handleAdd}
                      className="group inline-flex items-center px-8 py-4 bg-gradient-to-r from-emerald-600 to-teal-600 hover:from-emerald-700 hover:to-teal-700 text-white font-bold rounded-2xl transition-all duration-300 shadow-xl hover:shadow-2xl hover:scale-105 transform"
                    >
            ...
            <div className="mb-8 p-5 bg-white rounded-2xl shadow-lg border-l-4 border-emerald-500">
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-emerald-700">{deleteFetcher.data.message}</p>
                </div>
              </div>
            </div>
          )}
            ...
            <div className="relative bg-white rounded-3xl shadow-2xl p-16 text-center overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <p className="text-lg text-slate-600 mb-10 max-w-lg mx-auto leading-relaxed">
                  Add your first address to make checkout faster and easier. You can save multiple addresses for different locations.
                </p>
                <button
                  onClick={handleAdd}
                  className="group inline-flex items-center px-10 py-4 bg-gradient-to-r from-emerald-600 to-teal-600 hover:from-emerald-700 hover:to-teal-700 text-white font-bold rounded-2xl transition-all duration-300 shadow-xl hover:shadow-2xl hover:scale-105 transform"
                >
                  ...
                  <div className="relative z-10 p-8">
                    ...
                    <div className="flex items-start gap-4 mb-6">
                      ...
                      <div className="flex-1">
                        ...
                        {address.company && (
                          <p className="text-sm text-slate-600 mt-1 font-medium">{address.company}</p>
                        )}
                      </div>
                    </div>
                    ...
                    <div className="flex gap-3">
                      ...
                      >
                        <svg className="w-4 h-4 mr-2 inline group-hover/btn:scale-110 transition-transform duration-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="relative w-full max-w-md bg-white rounded-3xl shadow-2xl overflow-hidden transform transition-all">
              ...
              <div className="p-6">
                <p className="text-slate-700 text-center mb-8 leading-relaxed">
                  Are you sure you want to delete this address? All associated information will be permanently removed from your account.
                </p>
